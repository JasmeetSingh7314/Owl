...
export const mintNFT = async (nftDetails:nftObject) => {
  try {
    ...
    const contract = await tezos.wallet.at('KT1LEvXEkkcgXpb3cpp3nGC6MKHyk1HwVkKG');
...
export const transferNFT=async(transferDetails:transferObject)=>{
  try{
    const contractInstance=await tezos.wallet.at('KT1Ww42x3PVSm1hf5T5uwtEZDcFvbmaJkEW5');
