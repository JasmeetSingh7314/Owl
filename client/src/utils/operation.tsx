...
export const mintNFT = async (nftDetails:nftObject) => {
  try {
    ...
    const contract = await tezos.wallet.at('KT1NAcdkcBeJdMNkx36jyvtZ9qyJcomvNQuC');
...
export const transferNFT=async(transferDetails:transferObject)=>{
  try{
    const contractInstance=await tezos.wallet.at('KT1NAcdkcBeJdMNkx36jyvtZ9qyJcomvNQuC');
