...
export const mintNFT = async (nftDetails:nftObject) => {
  try {
    ...
    const contract = await tezos.wallet.at('KT1Uc2Z5BEVa1AgfkKXNciGK21MpnZUmXLw2');
...
export const transferNFT=async(transferDetails:transferObject)=>{
  try{
    const contractInstance=await tezos.wallet.at('KT1CJkLeHVq4N4wGiC7bs9KJeKN7zTqUNBp1');
