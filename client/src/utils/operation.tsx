...
export const mintNFT = async (nftDetails:nftObject) => {
  try {
    ...
    const contract = await tezos.wallet.at('KT1MHHPZqkqpjQTE5pRsQ61fhZT2roqe6e1E');
...
export const transferNFT=async(transferDetails:transferObject)=>{
  try{
    const contractInstance=await tezos.wallet.at('KT1LefoMVyr687UYWEPj4mdrVZiFGYkKtN41');
