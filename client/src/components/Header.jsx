    ...
    <header className="w-full text-gray-700 bg-black flex justify-center  border-gray-100 shadow-sm body-font">
        <div className=" flex flex-col  items-center p-3 w-full md:flex-row">
            ...
            <nav className="flex flex-wrap items-center text-base lg:w-2/5 md:ml-auto">
                <a href="#_" className="mr-5 font-medium font-montserrat pl-10 text-white">Home</a>
                <a href="#_" className="mr-5 font-medium font-montserrat pl-10 text-white ">Collection</a>
                <a href="#_" className="font-medium font-montserrat text-white ">Marketplace</a>
            </nav>
            <a
            ...
            <div className="inline-flex items-center h-full ml-5 lg:w-2/5 lg:justify-end lg:ml-0">
                <a href="#_" className="mr-5  font-montserrat font-medium hover:text-grey-900 ">Login</a>
                <a href="#_"
                    className="px-4 py-2 text-xs font-bold text-white font-montserrat uppercase transition-all duration-150 bg-teal-500 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease">
                    Sign Up
                </a>
            </div>
        </div>
