...
//   }, []);
  const onConnectWallet=async ()=>{
    ...
    //     TempleWallet.isAvailable()
    //      .then(() => {
    //          const mywallet = new TempleWallet('Owl');
    ...
    <header className="w-full text-gray-700 bg-black flex justify-center  border-gray-100 shadow-sm body-font">
        <div className=" flex flex-col  items-center p-3 w-full md:flex-row">
            ...
            <nav className="flex flex-wrap order-first items-center text-base lg:w-1/2  md:ml-auto">
                ...
                <a href="marketplace" className="font-medium font-montserrat text-white ">Marketplace</a>
            </nav>
            <a
                className="flex  items-center  mb-8 font-medium text-gray-900 lg:order-none lg:w-1/5 title-font lg:items-center lg:justify-center md:mb-0">
