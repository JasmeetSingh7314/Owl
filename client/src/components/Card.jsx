...
<div class="card ">
    ...
    <div class="details">
      <div class="center">
        ...
        <button className="px-4 py-2 text-xs font-bold  text-white font-montserrat  transition-all duration-150 bg-red-700 rounded shadow outline-none active:bg-red-100 hover:shadow-md focus:outline-none ease">Buy</button>
      </div>
    </div>
  </div>
  )
