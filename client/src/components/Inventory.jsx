    ...
    const fetchData = async () => {
      ...
      try {
        const response= await axios.get(
          `https://api.ghostnet.tzkt.io/v1/contracts/KT1NAcdkcBeJdMNkx36jyvtZ9qyJcomvNQuC/bigmaps/data/keys`
        );
        const response1  = await axios.get(
          `https://api.ghostnet.tzkt.io/v1/contracts/KT1Mj3dxRjoaLo5vhuUxYWEvdWQL7ykUtPfY/bigmaps/token_metadata/keys`
        );
