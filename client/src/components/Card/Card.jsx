...
import { collectNFT, mintNFT,transferNFT } from '../../utils/operation';
...
const Card = ({ header,description,id,rating,image,newimage,isDiff,tokenId}) => {
      ...
      <div class="center">
        ...
        {isDiff?(
          ...
          <div>
             ...
             <p className='italic'>Owner:{rating}</p>
